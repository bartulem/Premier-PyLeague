...
seasonsID = {'2007-08': '16', '2008-09': '17', '2009-10': '18', '2010-11': '19', '2011-12': '20', '2012-13': '21', '2013-14': '22', '2014-15': '27', '2015-16': '42',
             '2016-17': '54', '2017-18': '79', '2018-19': '210', '2019-20': '274'}
playerID = {'David de Gea': '4330', 'Ashley Young': '3062', 'Antonio Valenica': '3285', 'Chris Smalling': '3613', 'Phil Jones': '3820',
            ...
            'Gary Neville': '321', 'Wes Brown': '1211', 'John OShea': '1717', 'Gerard Piqué': '2737', 'Aaron Wan-Bissaka': '14164',
            'Brandon Williams': '23834', 'Harry Maguire': '9566',
            ...
            'Jihai Sun': '2296', 'João Cancelo': '5051', 'Angeliño': '10467',
            ...
            'Reece James': '14571', 'Kurt Zouma': '5175', 'Fikayo Tomori': '13281',
            ...
            'Mikaël Silvestre': '1719', 'Philippe Senderos': '2412', 'Kieran Tierney': '12185', 'Calum Chambers': '4620',
            ...
            'Pascal Chimbonda': '3026', 'Yeong-pyo Lee': '2988', 'Paulo Gazzaniga': '4600'}
...
injuryCodes = {'David de Gea': '59377', 'Ashley Young': '14086', 'Antonio Valenica': '33544', 'Chris Smalling': '103427', 'Phil Jones': '117996',
               ...
               'Gary Neville': '3403', 'Wes Brown': '3405', 'John OShea': '3540', 'Gerard Piqué': '18944', 'Aaron Wan-Bissaka':  '477758',
               'Brandon Williams':  '507700', 'Harry Maguire':  '177907',
               ...
               'Jihai Sun': '3806', 'João Cancelo': '182712', 'Angeliño': '277179',
               ...
               'Reece James': '472423', 'Kurt Zouma': '157509', 'Fikayo Tomori': '303254',
               ...
               'Mikaël Silvestre': '3393', 'Philippe Senderos': '4277', 'Kieran Tierney': '300716', 'Calum Chambers': '215118',
               ...
               'Pascal Chimbonda': '18875', 'Yeong-pyo Lee': '6156', 'Paulo Gazzaniga': '195488'}
...
playersBYseasons = {'2007-08': {'MU': {'GK': ['Edwin van der Sar'], 'RB': ['Wes Brown', 'John OShea'], 'LB': ['Patrice Evra'], 'CB': ['Rio Ferdinand', 'Nemanja Vidic', 'Gerard Piqué', 'Mikaël Silvestre']},
                    ...
                    '2019-20': {'MU': {'GK': ['David de Gea'], 'RB': ['Ashley Young', 'Aaron Wan-Bissaka', 'Diogo Dalot'], 'LB': ['Luke Shaw', 'Brandon Williams'], 'CB': ['Harry Maguire', 'Phil Jones', 'Eric Bailly', 'Victor Lindelöf']},
                                'MC': {'GK': ['Ederson'], 'RB': ['Kyle Walker', 'João Cancelo'], 'LB': ['Benjamin Mendy', 'Angeliño'], 'CB': ['John Stones', 'Nicolás Otamendi', 'Aymeric Laporte']},
                                'LFC': {'GK': ['Alisson'], 'RB': ['Trent Alexander-Arnold'], 'LB': ['Andrew Robertson'], 'CB': ['Virgil van Dijk', 'Dejan Lovren', 'Joe Gomez', 'Joël Matip']},
                                'CFC': {'GK': ['Kepa'], 'RB': ['César Azpilicueta', 'Reece James'], 'LB': ['Marcos Alonso', 'Emerson'], 'CB': ['Antonio Rüdiger', 'Andreas Christensen', 'Kurt Zouma', 'Fikayo Tomori']},
                                'AFC': {'GK': ['Bernd Leno'], 'RB': ['Héctor Bellerín'], 'LB': ['Kieran Tierney', 'Sead Kolasinac'], 'CB': ['Calum Chambers', 'David Luiz', 'Rob Holding', 'Shkodran Mustafi', 'Sokratis']},
                                'TH': {'GK': ['Hugo Lloris', 'Paulo Gazzaniga'], 'RB': ['Serge Aurier'], 'LB': ['Danny Rose', 'Ben Davies'], 'CB': ['Toby Alderweireld', 'Jan Vertonghen', 'Davinson Sánchez', 'Juan Foyth']}}}
...
def getInjuries(aplayer, theseason):
    aplayerCleaned = aplayer.lower().replace(' ', '-').replace('ö', 'o').replace('ë', 'e').replace('á', 'a').replace('í', 'i').replace('é', 'e').replace('î', 'i').replace('ü', 'u').replace('è', 'e').replace('ô', 'o').replace('ú', 'u').replace('Á', 'A').replace('ä', 'a').replace('ã', 'a').replace('ñ', 'n')
